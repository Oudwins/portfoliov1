...
export default [
  {
    ...
    lgDescription: ` <p>UCocktail es un buscador de cockteleria 100% responsive, desarrollado y diseñado en su totalidad por Tristan Mayo.El buscador no usa ningún tipo de backend sino que se nutre de CocktailDB, una api de recetas de bebidas.Además, se trata de una página de habla inglesa.</p><br/>
  ...
  <p>El buscador tiene diversas funcionalidades. Permite la busqueda por ingrediente o por nombre de bebida sin necesidad de cambiar ningún parámetro (puede probar a buscar "Lemon" y "Margarita"). En caso de obtener más de 8 resultados de la busqueda introducira paginación. Finalmente tiene un sistema de recomendaciones incorporado basado en los ingredientes de la bebida que se está visualizando.</p>`,
    skills: { html: lang.skills.html, scss: lang.skills.sass, bootstrap: frameworks.skills.bootstrap, js: lang.skills.js, vue: frameworks.skills.vue, api: { name: 'CocktailDB', img: 'skills/api-logo.svg' }, /*  */ html: lang.skills.html, scss: lang.skills.sass, bootstrap: frameworks.skills.bootstrap, js: lang.skills.js, vue: frameworks.skills.vue, api: { name: 'CocktailDB', img: 'skills/api-logo.svg' } },
  ...
  },
  {
    ...
    lgDescription: `<p>Zwary es una página web para un restaurante de alta gama. Está desarrollada y diseñada en su plenitud por Tristan Mayo y es 100% responsive.</p><br/>
