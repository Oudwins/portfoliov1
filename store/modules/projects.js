...
export default [
  {
    ...
    lgDescription: ` <p>UCocktail es un buscador de cockteleria 100% responsive, desarrollado y diseñado en su totalidad por mi. El buscador no usa ningún tipo de backend sino que se nutre de CocktailDB, una api de recetas de bebidas. Además, se trata de una página de habla inglesa.</p><br/>
